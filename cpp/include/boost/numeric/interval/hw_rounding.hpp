// Shadow header for WASM: adds Emscripten support to Boost.Numeric.Interval
// rounding control detection. Original file lacks a WASM/Emscripten path.
...
// Architecture-specific rounding control
...
// C99 fesetround() fallback for platforms without hardware rounding
// (including Emscripten/WASM)
